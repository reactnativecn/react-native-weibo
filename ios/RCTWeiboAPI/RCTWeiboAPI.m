                  ...
                  :(RCTResponseSenderBlock)callback)
{
    ...
    if (imageUrl.length && _bridge.imageLoader) {
        ...
        [_bridge.imageLoader loadImageWithURLRequest:imageUrl:imageUrl size:size scale:1 clipped:FALSE resizeMode:UIViewContentModeScaleToFill progressBlock:nil completionBlock:^(NSError *error, UIImage *image) {
